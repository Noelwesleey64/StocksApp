...
@Composable
fun LoginMain(registrationViewModel: RegistrationViewModel = hiltViewModel()){
LazyColumn(modifier = Modifier
  ...
  item {
      ...
      TextFields(registrationViewModel)
...
@Composable
fun TextFields(registrationViewModel: RegistrationViewModel){
            ...
            trailingIcon = {
                           if(showPassword){
                               IconButton(onClick = {
                                   ...
                                   Icon(painter = painterResource(id = R.drawable.visibility), contentDescription = "visible", tint = MaterialTheme.colorScheme.primary)
                               }
                           }else{
                               IconButton(onClick = {
                                                    showPassword = true
                               } , modifier = Modifier.size(20.dp)) {
                                   Icon(painter = painterResource(id = R.drawable.visibilityoff), contentDescription = "not visible", tint = MaterialTheme.colorScheme.primary)
                               }
                           }
            },
            modifier = Modifier
